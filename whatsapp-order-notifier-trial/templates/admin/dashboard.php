...
<div class="won-app" id="won-app">
    <!-- Trial Upgrade Banner inside dashboard -->
    <div style="background:linear-gradient(135deg,rgba(37,211,102,0.08),rgba(6,182,212,0.05));border:1px solid rgba(37,211,102,0.2);border-radius:14px;padding:16px 20px;margin-bottom:20px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;">
        <div style="display:flex;align-items:center;gap:10px;">
            <span style="font-size:22px;">⏱️</span>
            <div>
                <span style="color:#fff;font-weight:700;font-size:14px;">FREE TRIAL</span>
                <span style="color:#94A3B8;font-size:12px;margin-left:6px;">All features active for 24 hours</span>
            </div>
        </div>
        <a href="<?php echo esc_url( WON_UPGRADE_URL ); ?>" target="_blank" style="display:inline-block;padding:10px 24px;background:linear-gradient(135deg,#25D366,#128C7E);color:#fff;text-decoration:none;border-radius:8px;font-weight:700;font-size:13px;box-shadow:0 4px 15px rgba(37,211,102,0.3);">🔥 Upgrade to Pro — $19 (Lifetime)</a>
    </div>
        ...
        <div class="won-header__left">
            <div class="won-logo">
                ...
                <div>
                    ...
                    <span class="won-badge won-badge--version">v<?php echo esc_html( WON_TRIAL_VERSION ); ?> • Free & Self-Hosted</span>
                </div>
            </div>
        </div>
